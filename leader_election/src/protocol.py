...
class Protocol:
    ...
    def send_election(self, address, port, leader_id: int):
    ...
    #         self.peer_socket.sendall(message_type)
    #         self.peer_socket.sendall(result_len)
    #         self.peer_socket.sendall(result)
    #         return True
